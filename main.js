		 ...
		 for( var y = 0; y < level1.layers[layerIdx].height; y++ )
		 {
			 ...
			 for( var x = startX; x < startX + maxTiles; x++ )
			 {
				 if( level1.layers[layerIdx].data[idx] != 0 )
				 {
					 ...
					 // so subtract one from the tileset id to ge the 
					 // correct tile
...
function run()
{
	...
	context.font="25px Aldo the Apache";
	...
	for(var i=0; i<lives; i++)
	 {
	 // 10 is the distance from the top of the context
	 // 20 is the gap between hearts
